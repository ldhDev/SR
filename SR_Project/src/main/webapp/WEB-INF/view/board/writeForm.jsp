...
<div class="caption"><h3>게시물 작성</h3></div>
...
<form:form modelAttribute="board" action="write.bike" name="f" id="frm">
	...
	<div class="line">
		...
		<div style="display: inline;">
			<label><input type="radio" name="type" value="1" checked="checked" >&nbsp;잡담</label> &nbsp;&nbsp;&nbsp;
			<label><input type="radio" name="type" value="2">&nbsp;정보</label> &nbsp;&nbsp;&nbsp;
			<label><input type="radio" name="type" value="3">&nbsp;질문</label> &nbsp;&nbsp;&nbsp;
			<!-- 
	...
	<div class="con_line">
		<div style="display: inline;"><textarea id="con"></textarea></div>
